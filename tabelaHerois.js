const heroisTable = [
	...
	[
		...
		"Stan Lee\nJack Kirby",
		"Chris Claremont\nSteve Leialoha",
		" Stan Lee Tom DeFalco Steve Ditko Ron Frenz ",
		"Allan Heinberg\nDavid Michelinie\nJim Cheung",
		"None",
		"Creators \nLen Wein\nDave Cockrum",
		"Chris Claremont\nBob McLeod",
	...
	[
		...
		"Banshee is a mutant with a sonic scream. Born in Ireland, he pursued a career in Interpol, the X-Men, Generation X as Co-Headmaster, and founded X-Corp. He is the father of Theresa Cassidy as well as Black Tom Cassidy's cousin.",
		...
		"T'Challa is the Black Panther, Former king of Wakanda, one of the most technologically advanced nations on Earth. He is among the top intellects of the world, a veteran Avenger, and a member of the Illuminati. Using his powers and abilities, he has pledged his fortune, powers, and life to the service of all mankind.",
		...
		"Cannonball is a mutant with the ability to propel himself through the air like a human rocket. Over the years, Sam has grown from a New Mutant, to the leader of the original X-Force, to a full-fledged X-Man. He currently teaches at the Jean Grey School and is an Avenger.",
		...
		"After he was kidnapped by terrorists and gravely injured, billionaire industrialist and brilliant engineer Tony Stark was pressured to create a weapon of mass destruction. Instead, he created a suit of power armor to escape. Now vowing to protect the world he helped endanger, he became the Invincible Iron Man.",
		...
		"Jubilee, once a teenage mutant, became a member of the X-Men who could release colorful explosive plasmoids and detonate matter at a sub-atomic level. Robbed of her powers by M-Day, she has since been transformed into a vampire. Most recently, she rescued and adopted a baby boy from a meteor explosion.",
		...
		"The self-proclaimed kingpin of crime, Wilson Fisk is one of the most prominent figures of organized crime in the United States. He is the king of mobsters, controlling organized crime on the East Coast with an iron fist.",
		...
		"A Native American and member of the original New Mutants, Dani Moonstar was one of many mutants to lose their powers on M-Day. Moonstar currently uses her skills, experience and combat prowess to fight against evil as Hel's Valkyrie and one of the Fearless Defenders.",
		...
		"Nicholas Joseph Fury served in World War II as the leader of the Howling Commandos. He later became an agent, and eventually director, of S.H.I.E.L.D. Fury is one of the greatest strategic minds in the world, a born leader and a master of espionage.",
		"The daughter of Robert & Tina Minoru who was the unofficial leader of the Runaways.",
		...
		"The mutant mistress of magnetism, Polaris is also the daughter of Magneto. After a long sojourn in space she rejoined the ranks of X-Factor, fought alongside the X-Men against the Avengers, and now leads Serval Industries' All New X-Factor.",
		...
		"The bouncing and dwarfish dynamo of Alpha Flight, the good natured Puck is the heart and soul of the team. He has also recently joined Psylocke and Storms' Uncanny X-Force in the Marvel NOW! relaunch.",
		"Pyro is a mutant with the psionic ability to manipulate flame. He was a member of the Brotherhood of Evil Mutants & Freedom Force. He died from the effects of the Legacy Virus, but has been resurrected by Eli Bard to work for Selene.",
		"Quicksilver is a mutant with the ability to travel, at speeds far beyond, the average human. He is the twin brother, of the Scarlet Witch. After he and his sister left the Brotherhood, of Evil Mutants, they both became members of the Avengers. Although Quicksilver's loyalties and reliability have long been erratic, his love for his sister has proven constant. He is currently a member of the New X-Factor team led by Polaris.",
		...
		"A long-time member of Alpha Flight, Walter Langkowski has the ability to transform at will into the fearsome and powerful Sasquatch. He gained his powers while trying to duplicate the conditions that had created the Hulk, but inadvertently fused his body with the essence of the Great Beast, Tanaraq, instead.",
		"The probability manipulating and reality warping mutant known as the Scarlet Witch is also mother to Wiccan and Speed, sister to Quicksilver and also the power behind the mutant catastrophe, M-Day. A long time Avenger, she is currently a member of the Avengers Unity Squad.",
		"Advanced androids designed to hunt down and eliminate mutants.",
		...
		"The Stepford Cuckoos are five powerful telepaths - cloned daughters of Emma Frost's - who can combine their telepathic abilities to create a much more powerful hive-mind. The three remaining Cuckoos are currently students at the New Charles Xavier School for Mutants.",
		"Gifted with the power to control the forces and elements that govern weather Storm stands among the most powerful mutants on the planet. A former thief, “goddess”, and queen, Storm is a veteran member and mainstay of the X-Men. She is the team’s field leader and the Headmistress of the Jean Grey School.",
		"Roberto Da Costa is a mutant with the ability to harness the sun's power and possesses superhuman strength, speed, and durability. Born in Brazil, Roberto comes from a wealthy family and has been described as brash and quick tempered. Initially a member of the New Mutants, Roberto has since developed a long history with various X-Men related teams as well as some villains. Currently, he is a member of the Avengers.",
		"Elizabeth Twoyoungmen is the only daughter by the Alpha Flight resident magician, Shaman. Estranged from her father for many years, a magical discovery brings them back together. She has taken on a powerful native American artifact and with its prowess joined Alpha Flight also.",
		...
		"Billy Kaplan, an electrokinetic mutant with magical and reality warping abilities, joined the Young Avengers under the name Asgardian (which was later changed to Wiccan) as part of Vision's fail safe program to ensure the existence of the Avengers team. Wiccan and his teammate Speed are believed to be the reincarnations of the Scarlet Witch's dead twin sons. He is considered a powerful mage, and was revealed to be the Demiurge, a being of great power, destined to one day rewrite the laws of magic.",
		...
		"Laura is the product of a different section of Weapon X. She was cloned from Wolverine's damaged DNA - from the salvaged part of his X chromosome - and born to Sarah Kinney, her mother and the scientist who made her birth possible. Since she could walk, she was trained to be the perfect replication and killer of Wolverine. Under Wolverine and Gambit's guidance, she has since 'found herself'.",
