...
/*console.log(getDataBattle("Super Name")[0]);

for(head of getDataBattle("Super Name")[0]){
  console.log(head);
}*/
...
//   for(hero1 of getDataBattle("Super Name")[0]){
...
//   option.value = "none";
//   dropHeroMenu1.appendChild(option);
//   for(hero2 of getDataBattle("Super Name")[0]){
//     var optionItem = document.createElement("option");
